...
public class part1 {
    ...
    public String classifyData(String testFile) throws IOException
    {
         ...
         for (int i = 0; i < numberRecords; i++)
         {
             ...
             outputData += part1driver.deconvertCredit(attributeArray[0]) + " ";

             outputData += part1driver.deconvertIncome(attributeArray[1]) + " ";

             outputData += part1driver.deconvertAge(attributeArray[2]) + " ";

             outputData += part1driver.deconvertSex(attributeArray[3]) + " ";

             outputData += part1driver.deconvertMaritalStatus(attributeArray[4]) + " ";
            	             
             //find class of attributes
             int className = classify(attributeArray);
             
             //write class name
             outputData += part1driver.convertNumberToClass(className) + "\n";
	...
	//Method reads records from test file, determines their classes, 
	//and writes classes to classified file
	public void classifyData1(String testFile, String classifiedFile) throws IOException
	{
		Scanner inFile = new Scanner(new File(testFile));
		PrintWriter outFile = new PrintWriter(new FileWriter(classifiedFile));
    ...
    public int validate(String validationFile) throws IOException
    {
         ...
         //read actual class
         int actualClass = (int)inFile.nextDouble();
